...
Wie erhoffen uns mit unserer Rakete nicht nur Einblicke in die Luft- und Raumfahrttechnik zu erhalten sondern möglicherweise auch einen kleinen Beitrag zur Erforschung von Hybridtriebwerken oder anderen Raketensystem leisten zu können.
    ...
    <div class="parent">
      <div class="parachute">
        <h2>Fallschirm</h2>
        <div class="line"></div>
        <p>Das Fallschirmsystem unserer Rakete, die für den EUROC-Wettbewerb entwickelt wurde, spielt eine entscheidende Rolle bei der sicheren Rückführung der Nutzlast. Nach dem Erreichen der geplanten Flughöhe von 3000 Metern wird das zweistufige Fallschirmsystem ausgelöst. Zunächst sorgt ein kleinerer Drogue-Fallschirm für die Stabilisierung und Verlangsamung des Abstiegs. Auf einer Höhe von etwa 500 Metern öffnet sich dann der Hauptfallschirm, um eine sanfte Landung der Rakete zu gewährleisten. Das gesamte System wurde sorgfältig berechnet und getestet, um sowohl die Strukturintegrität der Rakete als auch die Sicherheit der Nutzlast zu gewährleisten.</p>
      </div>
      <div class="electronics">
        <h2>Elektronik</h2>
        <div class="line"></div>
        <p>Die On-Board-Elektronik unserer Rakete, die beim EUROC-Wettbewerb eingesetzt wird, ist ein zentraler Bestandteil für die erfolgreiche Mission. Sie umfasst ein Flight-Computer-System, das für die Steuerung und Überwachung aller kritischen Prozesse verantwortlich ist. Dazu gehören die Erfassung und Aufzeichnung von Flugdaten, die Auslösung des Fallschirmsystems in den richtigen Phasen sowie die Aktivierung von Sicherheitssystemen im Notfall.

          Zudem sind verschiedene Sensoren wie Höhenmesser, Beschleunigungssensoren und GPS-Module integriert, um präzise Echtzeit-Daten zu liefern. Diese Informationen werden sowohl für die Steuerung während des Flugs als auch für die spätere Analyse genutzt. Die Elektronik wurde speziell entwickelt und programmiert, um unter den extremen Bedingungen eines Raketenflugs zuverlässig zu funktionieren.</p>
      </div>
      <div class="engine">
        <h2>Triebwerk</h2>
        <div class="line"></div>
        <p>Das Triebwerk unserer Rakete, entwickelt für den EUROC-Wettbewerb, ist das Herzstück der Mission. Es handelt sich um ein Feststofftriebwerk, das sorgfältig ausgewählt und optimiert wurde, um die Rakete auf die geplante Höhe von 3000 Metern zu bringen. Das Triebwerk liefert den notwendigen Schub, um die Rakete sicher durch die verschiedenen Phasen des Flugs zu bringen, vom Start bis zum Erreichen der Maximalhöhe.

          Besonderes Augenmerk wurde auf die thermische Stabilität und die effiziente Verbrennung des Treibstoffs gelegt, um eine gleichmäßige Beschleunigung und optimale Flugbahn zu gewährleisten. Das Design des Triebwerks und die Auswahl der Materialien wurden intensiv getestet, um den extremen Bedingungen standzuhalten und gleichzeitig die Sicherheit des gesamten Systems zu gewährleisten. Zudem wurde das Triebwerk so konstruiert, dass es sich nahtlos in die gesamte Raketenstruktur integriert und maximale Leistung bei minimalem Gewicht bietet.</p>
      </div>
